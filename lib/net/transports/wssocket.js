 ...
 */
var WebSocket = function(sserver,socket) {
  ...
  socket.on('message', function(data) {
    console.error('WebSocket getvvv data %j',data);
    var msg = sserver.decode(data);
...
WebSocket.prototype.disconnect = function(reason) {
